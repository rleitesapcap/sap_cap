using { Currency, Country, custom.managed, custom.cuid, sap } from './common';
namespace sap.estudo.cap;

aspect MasterData {}


entity Airline : cuid, MasterData {
...
entity Airport : cuid, MasterData {
...
entity Supplement : cuid, managed, MasterData {
...
entity Flight : cuid, managed, MasterData {
  // TODO:
